...
const Login=()=>{
    ...
    function renderInputs(){
        ...
        return(
            ...
            <input value={userName} placeholder="Enter your email..." onChange={event=>handleChange(event,EMAIL_INPUT)}/>
            <br/> {error.userName && <span className="error">You must enter your email...</span>}
            </div>
            <div className="pass-input">
            <img src={pass} alt="Pass"/>
            <input  value={userPass} placeholder="Enter your password..." onChange={event=>handleChange(event,PASS_INPUT)}/><br/>
            {error.userPass && <span className="error">You must enter your password...</span>}
            </div>
            </div>
        )
    }
